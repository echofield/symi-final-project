    ...
    <>
      <section className="relative isolate overflow-hidden py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-6xl px-6">
          <motion.div className="max-w-4xl" variants={staggerContainer} initial="initial" animate="animate">
            ...
            <motion.p variants={staggerItem} className="mt-6 text-sm font-medium uppercase tracking-[0.35em] text-[var(--forest-green)]">
              Two systems. One goal: you win more.
            </motion.p>
            <motion.div variants={staggerItem} className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <motion.p variants={staggerItem} className="mt-8 text-sm font-light uppercase tracking-widest text-black">
